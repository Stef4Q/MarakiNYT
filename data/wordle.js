// Wordle — anniversary edition
window.WORDLE_DATA = {
  // Today's answer(s). First entry is today's word.
  answers: [
    "AGAPI"
  ],
  // Accepted guesses. Includes the answer plus common 5-letter words.
  // Expand this list as you like — anything not on this list is rejected.
  validGuesses: [
    "AGAPI",
